...
for (let i2 = 0; i2 < starWarsCharacters.length; i2++) {
  if (starWarsCharacters[i2].gender === "female") {
    femaleCharacters.push(starWarsCharacters[i2].name)
  }
}
...
for (let i3 = 0; i3 < starWarsCharacters.length; i3++) {
  let character = starWarsCharacters[i3];
  switch (character.eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log("un personaggio ha un colore degli occhi che non coincide con quelli specificati")
      break;
  }
} 
...
while (i4 < starWarsCharacters.length) {
  crewMass += starWarsCharacters[i4].mass; 
  i4++;
}
...
for (let i5 = 0; i5 < starWarsCharacters.lenght; i5++) {
  if (starWarsCharacters[i5].gender === "n/a") {
    robotCharacters.push(starWarsCharacters[i5].name)
  }
}
